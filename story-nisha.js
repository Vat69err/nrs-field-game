const story = {
  ...
  start: {
    location: 'Aamba Kala Colony, Udaipur',
  ...
  scene_open_school: {
    location: 'Aamba Kala Colony, Udaipur',
    text: 'Her jethani keeps suggesting it: <em>open school se de lo aap</em> — take the board exam through open school. She listens. She does not say no. But when you push her — what would she study, does she want this — she pauses. Then: <em>Nahi, main aisi naukri karu.</em> She wants a job more than a degree. She has already spoken to a doctor at Geetanjali.',
    choices: [
  ...
  scene_center: {
    location: 'Aamba Kala Colony, Udaipur',
    text: 'Five or six lending centers, she says. Aarohan, Gramshakti, others. The meetings happen here — women coming, sitting, signing, leaving. She does not take referrals from outside the neighborhood. Only family. Only Aamba Kala. <em>Dar lagta hai na — koi kisht leke bhaag jaave toh inhone karwaya tha.</em> Fear is something she learned from a specific event.',
    choices: [
  ...
  scene_court: {
    ...
    text: 'Court marriage. Her family stayed in Bundi. His stayed here. <em>Yeh log jaante bhi nahi the ek dusre ko.</em> The two families had never met. The registration happened in a room with paperwork. Then she was here — in this city, in the same RIKO belt where she would later work, where she still lives. One room. <em>Shuru karna pada.</em> Start from nothing.',
    choices: [
  ...
  scene_geetanjali: {
    location: 'Near Geetanjali Hospital, Udaipur',
    text: 'She has been there many times — as a visitor, watching. <em>Ladieson ki dekhbhal karna, mujhe achha lagta hai ye.</em> She wants to look after women patients. She spoke to a doctor there — Archana madam — who said she would help. The plan: wait a year and a half, two at most, until Siya is bigger. Then go. <em>Mujhe yahi karna hai.</em> She said it once, then moved on to something else.',
    choices: [
